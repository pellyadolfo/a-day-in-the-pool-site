...
public class BlogItemPresenter extends Presenter<BlogItemPresenter.MyView, BlogItemPresenter.MyProxy> implements BlogItemUiHandlers {
    @ProxyStandard
    @NameToken(NameTokens.BLOGITEM)
    public interface MyProxy extends ProxyPlace<BlogItemPresenter> {
    }
    
    public interface MyView extends View, HasUiHandlers<BlogItemUiHandlers> {
    }
    ...
    @Inject
    public BlogItemPresenter(final EventBus eventBus,
                          final MyView view,
                          final MyProxy proxy,
