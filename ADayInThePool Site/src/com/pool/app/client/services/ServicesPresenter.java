...
public class ServicesPresenter extends Presenter<ServicesPresenter.MyView, ServicesPresenter.MyProxy> implements ServicesUiHandlers {
    @ProxyStandard
    @NameToken(NameTokens.SERVICES)
    public interface MyProxy extends ProxyPlace<ServicesPresenter> {
    }
    
    public interface MyView extends View, HasUiHandlers<ServicesUiHandlers> {
    }
    ...
    @Inject
    public ServicesPresenter(final EventBus eventBus,
                          final MyView view,
                          final MyProxy proxy,
