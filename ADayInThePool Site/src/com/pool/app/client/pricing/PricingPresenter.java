...
public class PricingPresenter extends Presenter<PricingPresenter.MyView, PricingPresenter.MyProxy> implements PricingUiHandlers {
    @ProxyStandard
    @NameToken(NameTokens.PRICING)
