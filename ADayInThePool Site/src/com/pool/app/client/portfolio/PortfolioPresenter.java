...
public class PortfolioPresenter extends Presenter<PortfolioPresenter.MyView, PortfolioPresenter.MyProxy> implements PortfolioUiHandlers {
    @ProxyStandard
    @NameToken(NameTokens.PORTFOLIO)
    public interface MyProxy extends ProxyPlace<PortfolioPresenter> {
    }
    
    public interface MyView extends View, HasUiHandlers<PortfolioUiHandlers> {
    }
    ...
    @Inject
    public PortfolioPresenter(final EventBus eventBus,
                          final MyView view,
                          final MyProxy proxy,
